...
import com.wangdian.mile.ioc.BeanHelper;
import com.wangdian.mile.mvc.Handler;
import com.wangdian.mile.mvc.HandlerExecutor;
...
import com.wangdian.mile.utils.ClassUtil;
    ...
    public List<Object> createActionMethodParamList(HttpServletRequest request, Handler handler) throws Exception {
        ...
        if (UploadHelper.isMultipart(request)) {
            ...
            if (MapUtil.isNotEmpty(requestParamMap)) {
                paramList.add(new Parameters(requestParamMap));
            }
        }
        // 返回参数列表
        return paramList;
