...
import com.wangdian.mile.mvc.upload.Multipart;
import com.wangdian.mile.mvc.upload.Multiparts;
import com.wangdian.mile.mvc.upload.Parameters;
import com.wangdian.mile.utils.FileUtil;
import com.wangdian.mile.utils.StreamUtil;
...
public class UploadHelper {
    ...
    public static List<Object> createMultipartParamList(HttpServletRequest request) throws Exception {
        ...
        // 初始化参数列表
        paramList.add(new Parameters(fieldMap));
